    ...
    <div class="flex flex-col h-full justify-end mx-auto w-1/2">
      ...
      <div class="flex flex-col">
        <div class="flex space-x-1">
          <div class="flex flex-col items-center w-10 -ml-10 mt-5">
            <button
              class="px-1 py-1 rounded-sm focus:outline-none"
              @click="videoPlayPause"
            >
              <div v-if="videoPlayer.paused === true">
                <svg
                  class="w-10 h-10 text-blue-500 bg-gray-400"
                  fill="currentColor"
                  viewBox="0 0 20 20"
            ...
            <button
              class="px-1 py-1 rounded-sm text-red-500 text-2xl font-semibold"
              @click="reduceVolume"
            >
              <svg
                class="w-10 h-10 text-blue-500 bg-gray-400"
